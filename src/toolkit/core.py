...
from sklearn.cluster import KMeans, DBSCAN, AgglomerativeClustering, MeanShift, estimate_bandwidth, SpectralClustering, MiniBatchKMeans, AffinityPropagation
...
class Core_engine:
    ...
    def decompose(self, X_train, decomposer = {'name':PCA, 'args':[], 'kwargs': {'n_components':2}}):
    ...
    def nested_cv(self, estimators, X_train, ):
